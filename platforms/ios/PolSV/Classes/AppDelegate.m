...
- (BOOL)application:(UIApplication*)application didFinishLaunchingWithOptions:(NSDictionary*)launchOptions
{
    [[PushAppsManager sharedInstance] setDelegate:self];
       [[PushAppsManager sharedInstance] startPushAppsWithAppToken:@"5ebcbd9a-8583-446e-81ee-f19e339fa88e" withLaunchOptions:launchOptions];
...
// only valid if PolSV-Info.plist specifies a protocol to handle
